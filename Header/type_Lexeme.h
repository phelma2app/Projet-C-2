...
#define MAP_ID			MAP_END+1
#define MAP_OPERATOR			MAP_ID+1
#define MAP_OPERATOR_AFF		MAP_OPERATOR+1
#define MAP_OPERATOR_SOURCE			MAP_OPERATOR_AFF+1
#define MOT 			MAP_OPERATOR_SOURCE+1			
#define NOMBRE 			MOT+1
