...
#define AFFECTATION_END		AFFECTATION+1
#define ARCHITECTURE 		AFFECTATION_END+1
...
#define CONDITION_END   CONDITION+1
#define ELSE			CONDITION_END+1
#define ELSIF			ELSE+1
